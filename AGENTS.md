...
Guidance for Codex working on Helora. Deep context lives in `rules/`, `docs/`, and `.claude/`.
...
- **Auto-memory (user-level):** `C:\Users\devin\.Codex\projects\d--Learning-Ai-Automation-Ankur-Sahni-Learning-Project\memory\MEMORY.md`
...
- [[CLAUDE.md]] — Master constraints (same hard constraints, this file is for Codex environments)
- [[rules/README.md]] — Full rules index: agent, coding, communication, client, n8n, AI
- [[docs/architecture.md]] — 7-layer system design and agent org chart
- [[.claude/agents/coo.md]] — COO is the primary entry point for all non-trivial requests
